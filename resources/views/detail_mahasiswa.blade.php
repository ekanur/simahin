...
<div class="container-fluid">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nama Depan" value="Dakota" disabled="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Belakang</label>
                                                <input type="text" class="form-control" placeholder="Nama Belakang" value="Race" disabled="">
                                            </div>
                                        </div>
                                    </div>
                              ...
                              <option value="02" selected="">Fakultas Sastra</option>
                              ...
                              <option value="021" selected="">Sastra Indonesia</option>
                              ...
                              <option value="081">Psikologi</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>NIM</label>
                                                <input type="text" class="form-control" placeholder="NIM" value="1011345849535" disabled="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Negara Asal</label>
                                                <input type="text" class="form-control" placeholder="Negara Asal" value="Prancis" disabled="">
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-4">
                                            <div class="form-group">
    ...
    cursor: pointer; z-index:1000;top:100px;margin-left:30px;opacity:0.00001">
                                    ...
                                    <img class="avatar border-gray" src="{{ url('/assets/img/faces/face-3.jpg') }}" alt="..."/>
                                      ...
                                      <h4 class="title">Dakota Rice<br />
                                         <small>1011345849535</small>
                                      </h4>
                                    </a>
                                </div>
                            ...
                            <div class="text-center">
                                ...
                                <button href="#" class="btn btn-simple btn-success">Ijin Belajar <i class="fa fa-check"></i></button>
